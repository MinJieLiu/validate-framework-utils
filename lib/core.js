...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(field) {
    ...
    var id, name, value, result, error, rules, isRequired, _loop, index, ruleLength, _ret;
                      ...
                      if (!result) {
                        Object.assign(error, {
                          ...
                          message: function () {
                            ...
                            return seqText ? seqText.replace(/{{\s*value\s*}}/g, value).replace(/{{\s*param\s*}}/g, param) : seqText;
                          }()
                        });
                      }
